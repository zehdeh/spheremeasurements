...
class MainWindow(QtWidgets.QMainWindow):
	...
	def addCamera(self, renderer, camera):
		...
		# quick bug fix in VTK:
		# Frustums are sometimes generated by VTK with ridiculous sizes
		# This puts the camera in a weird default position
		# To fix this, we re-generate the frustums so long until they have a reasonable size
		outOfBounds = True
		while outOfBounds:
